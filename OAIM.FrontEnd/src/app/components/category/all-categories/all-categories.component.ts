...
@Component({
  ...
  imports: [CommonModule, TopBarComponent, FormsModule, RouterLink, AddEditCategoryComponent],
...
totalCount = 0;
  ...
  ngOnInit(): void {
   ...
   loadCategories(){
     this.categoryApi.getAllCategories(this.pageNumber,this.pageSize).subscribe({
      next:(data)=>{
